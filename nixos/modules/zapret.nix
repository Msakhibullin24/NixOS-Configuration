  ...
  systemd.services.zapret = {
    ...
    serviceConfig = {
      ...
      EnvironmentFile = pkgs.writeText "zapret-environment" ''
        ...
        --filter-tcp=2053,2083,2087,2096,8443 --hostlist-domains=discord.media --dpi-desync=multisplit --dpi-desync-split-seqovl=681 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern=${./zapret/tls_clienthello_www_google_com.bin} --new
        --filter-tcp=443 --hostlist=${./zapret/list-general.txt} --dpi-desync=multisplit --dpi-desync-split-seqovl=681 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern=${./zapret/tls_clienthello_www_google_com.bin} --new
