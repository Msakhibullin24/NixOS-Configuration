# Generated by Powerlevel10k configuration wizard on 2025-02-16 at 16:35 MSK.
...
() {
  ...
  typeset -g POWERLEVEL9K_USER_BACKGROUND=147
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      res+="${clean}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON} (${(g::)POWERLEVEL9K_VCS_GITHUB_ICON} ${branch//\%/%%})"
    fi
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=225
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=225
